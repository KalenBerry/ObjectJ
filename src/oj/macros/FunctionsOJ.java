...
//        val[3]=113;
    ...
    //KB trying to make my own macro 11-11-14
   // public String ojSaveProjectAsThis(String filePath) {
  //      OJ.getMacroProcessor().saveProjectAsThis(filePath);
  //      return null;
  //  }
    ...
    public String ojTest() {

        MapsOJ maps = new MapsOJ();
        maps.saveAsZip();
        maps.openZip();
        return null;
    }
