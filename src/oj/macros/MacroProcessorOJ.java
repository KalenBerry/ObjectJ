...
//        imp.repaintWindow();
    ...
    //KB Added for implementing new macro 11-11-14
//    public void saveProjectAsThis(String filePath) {
//        new InputOutputOJ().saveProjectAsThis(OJ.getData(),filePath, true, true);
//    }
//   
    ...
    public void extendVisibilityDepth(int lowValue, int highValue) {
        ...
        //YtemDefsOJ someDefs = OJ.getData().getYtemDefs();
