...
public class UtilsOJ {
    ...
    public static String removeCommentsFromText(String text) {
        try {
...
//                    do nothing because is a comment
            ...
            Logger.getLogger(UtilsOJ.class.getName()).log(Level.SEVERE, null, ex);
        }
        return "";
    }
    ...
    public static void showInFinderOrExplorer() {
        ...
        if (IJ.isJava16()) {
            ...
            try {
                ...
                IJ.showMessage("An error ecccured while opening the folder");
                return;
            }
        } else {
