...
/** This class registers for image changing events
 * like ImageOpened, ImageClosed on ImageJ.
...
public class IjImageChangedListenerOJ implements ImageListener {
    ...
    /** Checks if path is equal to a linked path and applie graphics.
     * However, if this is the second instance of a linked image, it is
     * closed again
     */
