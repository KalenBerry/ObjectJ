/**
 * Column definition Panel within Project window
 * Completely documented 10.2.2010
 */
 ...
 *
 * Panel inside Project Settings
 * For creating ObjectJ result columns, connecting algorithms, and set histogram parameters
 */
public class ColumnSettingsOJ extends javax.swing.JPanel implements TableColumnModelListener, IControlPanelOJ, ColumnChangedListenerOJ, YtemDefChangedListenerOJ {
    ...
    private Dimension panelSize = new Dimension(585, 600);//29.1.2010
    ...
    private void fillOperations() {
    	// TODO : this is where you'll add the option to make the new operand type
        ...
        cbxOperation.addItem("Object number relative to image");
        cbxOperation.addItem("Sum pixel values");
    ...
    /**
     * Depending on the algorithm, a certain amount of parameters can be
     * defined by the user, while the rest remains invisible
     */
    ...
    /**
     * uses column definition to update panel showing histogram parameters (xmin, xmax, binwidth etc)
     */
    ...
    private void updateView() {
        ...
        if (column != null) {
            ...
            boolean nonAutomatic = column.getColumnDef().getAlgorithm() > ColumnDefOJ.ALGORITHM_LAST_AUTOMATIC && column.getColumnDef().getAlgorithm()< ColumnDefOJ.ALGORITHM_FIRST_CUSTOM ;//10.2.2010 //KB 1/13/15
            if (nonAutomatic) {//27.9.2009
            	...
            	int offset=1;//handles difference between the zero order menu and the index in columnDefOJ
            	if (column.getColumnDef().getAlgorithm()>= ColumnDefOJ.ALGORITHM_FIRST_CUSTOM)// takes care of differences due to the new custom operand types avaialable
            		offset=2+ColumnDefOJ.ALGORITHM_LAST_AUTOMATIC-ColumnDefOJ.ALGORITHM_FIRST_CUSTOM;
            	
            	if (cbxOperation.getSelectedIndex() != (column.getColumnDef().getAlgorithm() + offset)) {
            		cbxOperation.setSelectedIndex(column.getColumnDef().getAlgorithm() + offset);
            	}
            }
            ...
            switch (column.getColumnDef().getAlgorithm()) {
                ...
                case ColumnDefOJ.ALGORITHM_CALC_UNLINKED_TEXT:
                    ...
                    updateOperandsView(0, false, false);
                    break;
                case ColumnDefOJ.ALGORITHM_CALC_OBJECT_NUMBER_RELATIVE_TO_IMAGE: // implement stuff
                	updateOperandsView(0, false, false);
                	break;                	
                case ColumnDefOJ.ALGORITHM_CALC_PIXEL_AREA_SUM: // implement stuff
                    updateOperandsView(1, true, true);
                    updateYtemTypeText(column, 0);
                    updateCloneText(column, 0);
                    updatePointText(column, 0);
    ...
    private void initComponents() {
        ...
        tabbedColumnDetail.setFont(new java.awt.Font("Tahoma", 0, 12));
        ...
        lbOperation.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        cbxOperation.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        pnlFirstOperand.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lblFirstObjectType.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lblFirstClone.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        lblFirstClone.setText("Clone");
        ...
        lblFirstPoint.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        lblFirstPoint.setText("Point");
        ...
        cbxFirstObjectType.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        txtFirstClone.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        txtFirstPoint.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        pnlSecondOperand.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lblSecondObjectType.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lblSecondClone.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        lblSecondClone.setText("Clone");
        ...
        lblSecondPoint.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        lblSecondPoint.setText("Point");
        ...
        cbxSecondObjectType.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        txtSecondClone.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        txtSecondPoint.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        pnlThirdOperand.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lblThirdObjectType.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lblThirdClone.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        lblThirdClone.setText("Clone");
        ...
        lblThirdPoint.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        lblThirdPoint.setText("Point");
        ...
        txtThirdClone.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        txtThirdPoint.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        spinDigits.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lbPrecision.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lbColor.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        cbxColor.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        ...
        lbColumnAppearance.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        lbHistogram.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        pnlPresentationLayout.setVerticalGroup(
            ...
            .add(pnlPresentationLayout.createSequentialGroup()
                ...
                .add(14, 14, 14)
                .add(pnlPresentationLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(lbXMin, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
        ...
        btnNew.setFont(new java.awt.Font("Lucida Grande", 0, 12));
        btnNew.setText("New");
        ...
        btnRemove.setFont(new java.awt.Font("Lucida Grande", 0, 12));
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        OJ.getData().getResults().getColumns().addColumn(new ColumnOJ(name), true);//15.3.2009
    ...
    private void initComponentsExt() {
        ...
        /**
         * nameEditor is used when double-clicking on a column name in left table, or creating a new column
         */
    ...
    /**
     * first removes all operands from columnDef's operand array list, then creates
     * new ones and gives tham by default the name of the first ytemdefs such as "axis"
     */
...
private void cbxOperationItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbxOperationItemStateChanged
    ...
    if (column != null) {
        ...
        if (cbxOperation.getSelectedIndex()>ColumnDefOJ.ALGORITHM_LAST_AUTOMATIC+1){//kb THIS IS CRAZY. tRIED TO MAKE THIS SOMEWHAT DYNAMIC IF i WANT TO ADD MORE OPERANDS LATER
        	column.setAlgorithm(cbxOperation.getSelectedIndex()-2-ColumnDefOJ.ALGORITHM_LAST_AUTOMATIC+ColumnDefOJ.ALGORITHM_FIRST_CUSTOM );
        }else if (cbxOperation.getSelectedIndex() > 1) {//0 and 1 are "no algorithm"
            ...
            if (cbxOperation.getSelectedIndex() == 1) {
                column.setAlgorithm(ColumnDefOJ.ALGORITHM_CALC_UNLINKED_NUMBER);
            }
        ...
        switch (column.getColumnDef().getAlgorithm()) {
            ...
            case ColumnDefOJ.ALGORITHM_CALC_ID:
                ...
                break;
            case ColumnDefOJ.ALGORITHM_CALC_OBJECT_NUMBER_RELATIVE_TO_IMAGE:
            	column.getColumnDef().setColumnDigits(0);
                updateOperands(column.getColumnDef(), 0);
                break;
            case ColumnDefOJ.ALGORITHM_CALC_PIXEL_AREA_SUM:
                column.getColumnDef().setColumnDigits(2);
                updateOperands(column.getColumnDef(), 1);
                break;
            case ColumnDefOJ.ALGORITHM_CALC_FILE_NAME:
