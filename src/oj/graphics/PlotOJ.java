...
public class PlotOJ {
    ...
    /** Plots a city-shaped  histogram from a ObjectJ results column
     * using modified ImageJ plot window
     * Only qualified entries are used.
     */
...
//get adjustments from columns; if NaN use "automatic"
        ...
        plot = new Plot("Histogram of " + column.getName(), column.getName(), "count", ((double[]) null), ((double[]) null), flags);
        double[] xxAll = null;
        double[] yyAll = null;
        double[] xxQual = null;
        double[] yyQual = null;
...
//    }
    ...
    /**
     * When clicking "Modify", column settings must expose correct column settings
     */
