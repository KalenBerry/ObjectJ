...
public class ColumnsOJ extends BaseAdapterOJ implements StatisticsChangedListenerOJ {
    ...
    /**
     * return the name of the sorting flag
    ...
    /**
     * return the sorting flag type
     * possible values [COLUM_SORT_FLAG_NONE, COLUM_SORT_FLAG_DESCENDING, COLUM_SORT_FLAG_DESCENDING]
     * @return sort flag name
     */
    ...
    public boolean addColumn(ColumnOJ column, boolean initialize) {
