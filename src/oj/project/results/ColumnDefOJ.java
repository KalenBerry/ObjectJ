...
public class ColumnDefOJ extends BaseAdapterOJ {
  ...
  public static final int ALGORITHM_FIRST_CUSTOM = 24; //KB this is new to give a reference for new operations I wanted. 
  public static final int ALGORITHM_CALC_OBJECT_NUMBER_RELATIVE_TO_IMAGE = 24;
  public static final int ALGORITHM_CALC_PIXEL_AREA_SUM = 25;
  private String name;
...
private ArrayList operands = new ArrayList();
  ...
  public static String getAlgorithmName(int algorithm) {
    switch (algorithm) {
      ...
      case ColumnDefOJ.ALGORITHM_CALC_OBJECT_NUMBER_RELATIVE_TO_IMAGE:
    	return "objectnumreltoimg";
      case ColumnDefOJ.ALGORITHM_CALC_PIXEL_AREA_SUM:
    	return "SumOfPixelsWithinRegion";
      default:
        return "anynumber";
    }
  }
  ...
  public static int getAlgorithm(String name, String algorithm) {
    ...
    } else if ("objectnumreltoimg".equalsIgnoreCase(algorithm)) {
      return ColumnDefOJ.ALGORITHM_CALC_OBJECT_NUMBER_RELATIVE_TO_IMAGE;
    } else if ("SumOfPixelsWithinRegion".equalsIgnoreCase(algorithm)){
      return ColumnDefOJ.ALGORITHM_CALC_PIXEL_AREA_SUM;
